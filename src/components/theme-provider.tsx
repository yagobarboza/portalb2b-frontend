...
/** ✅ Aplica color-scheme para scrollbars/nativos acompanharem o tema E previne flash. */
function applyColorScheme(resolved: ResolvedTheme) {
  const root = document.documentElement
  root.style.colorScheme = resolved

  // Previna o flash de tema errado (FOUC) em reload
  const meta = document.querySelector<HTMLMetaElement>('meta[name="theme-color"]')
  if (meta) meta.setAttribute("content", resolved === "dark" ? "#09090b" : "#ffffff")
}
