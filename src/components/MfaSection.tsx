...
/**
 * Seção de configuração de MFA (autenticação de dois fatores).
 *
 * Reutilizável: renderiza apenas o Card "Segurança", SEM wrapper de página
 * (sem <h1>, sem padding externo). Pode ser embutido em qualquer tela de
 * configurações (ex.: ProfileSettingsPage) ou usado como página autônoma.
 *
